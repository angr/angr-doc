...
def test_api_coverage():
    missing = []
    exclude = ['angr.tablespecs', 'angr.service', 'angr.analyses.girlscout', 'angr.analyses.vtable', 'angr.analyses.find_objects_static', 'angr.analyses.class_identifier', 'pyvex.vex_ffi', 'claripy.backends.remotetasks', 'claripy.backends.backendremote', 'cle.backends.idabin']
