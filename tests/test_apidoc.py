...
def test_lint_docstrings():
    ...
    if stderr:
        ...
        stderr = b"\n".join(l for l in stderr_lines if b'duplicate object description of claripy.backends, other instance in claripy, ' not in l and b'sphinx_rtd_theme/search.html:20' not in l and b'{{ super() }}' not in l)
